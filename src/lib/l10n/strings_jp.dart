...
class StringsJp implements AppStrings {
  ...
  @override String get tourTemplatesBody => '✨ によくある目標のテンプレートがあり、ターゲット・マイルストーン・タスクを一度に作れます。今回は自分で作ってみましょう。';
  ...
  @override String templateContents(int goals, int tasks) => '目標 $goals 件 · タスク $tasks 件';
