...
class StringsEn implements AppStrings {
  ...
  @override String get tourTemplatesBody => '✨ holds templates for common aims — targets, milestones and tasks in one tap. This time, make one yourself.';
  ...
  @override String templateContents(int goals, int tasks) => '$goals goals · $tasks tasks';
